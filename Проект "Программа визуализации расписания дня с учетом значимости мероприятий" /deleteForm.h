...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button_add1->Location = System::Drawing::Point(12, 150);
			this->button_add1->Name = L"button_add1";
			this->button_add1->Size = System::Drawing::Size(114, 43);
			this->button_add1->TabIndex = 0;
			this->button_add1->Text = L"”далить";
			this->button_add1->UseVisualStyleBackColor = true;
			this->button_add1->Click += gcnew System::EventHandler(this, &deleteForm::button_add1_Click);
			...
			this->TextNumb_1_1->TextChanged += gcnew System::EventHandler(this, &deleteForm::textBox1_TextChanged);
			this->TextNumb_1_1->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &deleteForm::TextNumb_1_1_KeyPress);
			...
			this->groupBox1->Enter += gcnew System::EventHandler(this, &deleteForm::groupBox1_Enter);
			...
			this->groupBox8->Size = System::Drawing::Size(425, 98);
			this->groupBox8->TabIndex = 7;
			this->groupBox8->TabStop = false;
			this->groupBox8->Text = L"”далить меропри€тие";
			...
			this->вернутьс€¬√лавноећенюToolStripMenuItem->Click += gcnew System::EventHandler(this, &deleteForm::вернутьс€¬√лавноећенюToolStripMenuItem_Click);
			...
			this->чтоЁтоToolStripMenuItem->Click += gcnew System::EventHandler(this, &deleteForm::чтоЁтоToolStripMenuItem_Click);

			this->AutoScaleDimensions = System::Drawing::SizeF(8, 16);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(449, 212);
			this->ControlBox = false;
			this->Controls->Add(this->groupBox8);
			this->Controls->Add(this->menuStrip1);
			this->Controls->Add(this->button_add1);
			this->Location = System::Drawing::Point(467, 259);
			this->MainMenuStrip = this->menuStrip1;
			this->MaximizeBox = false;
			this->MaximumSize = System::Drawing::Size(467, 259);
			this->Name = L"deleteForm";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"”далить меропри€тие";
...
#pragma endregion
	...
	private: System::Void TextNumb_1_1_KeyPress(System::Object^ sender, System::Windows::Forms::KeyPressEventArgs^ e) {
		if ((e->KeyChar >= '0') && (e->KeyChar <= '9') || (e->KeyChar == 0x08))   //если ввод€тс€ цифры от 0 до 9 то все ок
			return;
	...
	private: System::Void чтоЁтоToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
		MessageBox::Show("ѕозвол€ет удалить меропри€тие по выбранному пользователем номеру.", "»нформаци€");
	}
};
}
