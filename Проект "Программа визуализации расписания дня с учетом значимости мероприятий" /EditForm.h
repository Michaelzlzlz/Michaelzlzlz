...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void)
		{
			...
			this->button_add1->Location = System::Drawing::Point(12, 526);
			...
			this->button_add1->Click += gcnew System::EventHandler(this, &EditForm::button_add1_Click);
			...
			this->TextNumb_1_1->TextChanged += gcnew System::EventHandler(this, &EditForm::textBox1_TextChanged);
			this->TextNumb_1_1->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &EditForm::TextNumb_1_1_KeyPress);
			...
			this->groupBox1->Enter += gcnew System::EventHandler(this, &EditForm::groupBox1_Enter);
			...
			this->TextOpis_1_4->TextChanged += gcnew System::EventHandler(this, &EditForm::TextOpis_1_4_TextChanged);
			...
			this->TextNameMero_1_3->TextChanged += gcnew System::EventHandler(this, &EditForm::TextNameMero_1_3_TextChanged);
			...
			this->groupBox3->Text = L"—огласие(0-3)";
			...
			this->TextSogl_1_10->TextChanged += gcnew System::EventHandler(this, &EditForm::TextSogl_1_10_TextChanged);
			this->TextSogl_1_10->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &EditForm::TextSogl_1_10_KeyPress);
			...
			this->TextStart_1_5->ValueChanged += gcnew System::EventHandler(this, &EditForm::dateTimePicker1_ValueChanged);
			...
			this->groupBox8->Size = System::Drawing::Size(425, 474);
			this->groupBox8->TabIndex = 7;
			this->groupBox8->TabStop = false;
			this->groupBox8->Text = L"–едактировать меропри€тие";
			...
			this->TextSotr_1_2->TextChanged += gcnew System::EventHandler(this, &EditForm::TextSotr_1_2_TextChanged);
			...
			this->TextPriorit_1_9->TextChanged += gcnew System::EventHandler(this, &EditForm::TextPriorit_1_9_TextChanged);
			this->TextPriorit_1_9->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &EditForm::TextPriorit_1_9_KeyPress);
			...
			this->вернутьс€¬√лавноећенюToolStripMenuItem->Click += gcnew System::EventHandler(this, &EditForm::вернутьс€¬√лавноећенюToolStripMenuItem_Click);
			...
			this->чтоЁтоToolStripMenuItem->Click += gcnew System::EventHandler(this, &EditForm::чтоЁтоToolStripMenuItem_Click);

			this->label3->AutoSize = true;
			this->label3->Location = System::Drawing::Point(126, 453);
			...
			this->label2->Location = System::Drawing::Point(18, 439);
			...
			this->label1->Location = System::Drawing::Point(18, 410);
			...
			this->ClientSize = System::Drawing::Size(449, 581);
			...
			this->MaximumSize = System::Drawing::Size(467, 628);
			this->MinimumSize = System::Drawing::Size(467, 628);
			this->Name = L"EditForm";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"–едактировать меропри€тие";
...
#pragma endregion
	...
	private: System::Void чтоЁтоToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
		MessageBox::Show("»щет по номеру меропри€ти€, введенному пользователем. ¬ случае нахождени€ - мен€ет на новые данные о меропри€тии введенные пользователем.", "»нформаци€");
	}
};
}
