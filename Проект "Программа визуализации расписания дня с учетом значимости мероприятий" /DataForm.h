...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void)
		{
			...
			this->вернутьс€¬√лавноећенюToolStripMenuItem->Click += gcnew System::EventHandler(this, &DataForm::вернутьс€¬√лавноећенюToolStripMenuItem_Click);
			...
			this->чтоЁтоToolStripMenuItem->Click += gcnew System::EventHandler(this, &DataForm::чтоЁтоToolStripMenuItem_Click);
...
private: System::Void чтоЁтоToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
	MessageBox::Show("ѕри выборе  нопки \"8. ѕоказать выбранное меропри€тие из списка.\":\n¬ыводит список меропри€тий полностью.\n\nѕри выборе  нопки \"9. ѕоказать все меропри€тий в списке.\":\nѕозвол€ет отобразить меропри€тие по номеру, указанному пользователем.", "»нформаци€");
}
};
}
