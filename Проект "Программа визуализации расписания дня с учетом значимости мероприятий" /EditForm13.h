...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button_add1->Location = System::Drawing::Point(12, 285);
			...
			this->TextNumb_1_1->TextChanged += gcnew System::EventHandler(this, &EditForm13::textBox1_TextChanged);
			this->TextNumb_1_1->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &EditForm13::TextNumb_1_1_KeyPress);
			...
			this->TextStart_1_5->ValueChanged += gcnew System::EventHandler(this, &EditForm13::dateTimePicker1_ValueChanged);

			this->groupBox5->Controls->Add(this->TextdoStart_1_6);
			this->groupBox5->Location = System::Drawing::Point(208, 91);
			...
			this->groupBox6->Location = System::Drawing::Point(15, 154);
			...
			this->groupBox7->Location = System::Drawing::Point(208, 154);
			...
			this->вернутьс€¬√лавноећенюToolStripMenuItem->Click += gcnew System::EventHandler(this, &EditForm13::вернутьс€¬√лавноећенюToolStripMenuItem_Click);
			...
			this->чтоЁтоToolStripMenuItem->Click += gcnew System::EventHandler(this, &EditForm13::чтоЁтоToolStripMenuItem_Click);
...
#pragma endregion
	...
	private: System::Void TextNumb_1_1_KeyPress(System::Object^ sender, System::Windows::Forms::KeyPressEventArgs^ e) {
		if ((e->KeyChar >= '0') && (e->KeyChar <= '9') || (e->KeyChar == 0x08))   //если ввод€тс€ цифры от 0 до 9 то ок
			return;
		e->Handled = true; // остальные символы запрещены дл€ ввода
	}
	...
	private: System::Void чтоЁтоToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
		MessageBox::Show("ƒанна€ форма измен€ет врем€ начала и конца меропри€тии. ј также врем€ на трансфер до и после меропри€ти€.\n\n Ќапример, если пользователю необходимо сменить длительность пребывани€ на меропри€тии или изменить врем€ на трансфер.", "»нформаци€");
	}
};
}
